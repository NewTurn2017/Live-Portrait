...
class ArgumentConfig(PrintableConfig):
    ...
    flag_eye_lip_open_enabled: bool = False
    #########################################
    target_eye_ratio: float = 0.4  # default value for target eye openness ratio
    target_lip_ratio: float = 0.2  # default value for target lip openness ratio
    ########## crop arguments ##########
    dsize: int = 512
    scale: float = 2.3
